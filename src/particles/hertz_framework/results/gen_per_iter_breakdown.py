...
cuda_per_iter_labels = ['aos_memcpy', 'compute_kernel', 'gather_kernel', 'result_fetch']
cuda_bars = []
...
op2_per_iter_labels = ['compute_kernel', 'add_kernel', 'result_fetch']
op2_bars = []
...
plt.savefig("breakdown_runtime.png")
